...
const Navbar = () => {
	...
	// Fetch the number of stargazers of the repository (healthydev)
	useEffect(() => {
		const fetchStars = async () => {
			const response = await fetch("https://api.github.com/users/kumartul/repos");
			const repos = await response.json();

			const repo = repos.filter(repo => repo.name === "healthyDev");
			...
			<div className="flex items-center space-x-2">
				...
				<a href="https://www.twitter.com/kumartul001">
					<div className="flex items-center border border-gray-300 rounded-md px-2 py-1 bg-white transition-all duration-250 hover:bg-gray-100 dark:bg-black dark:border-gray-500">
						...
						<div className="px-2">
							<img
								src="/assets/images/atulkumar.png"
								alt="Atul Kumar"
								width={40}
								height={40}
				...
				{/* Github Card */}
				<a
					href="https://www.github.com/kumartul/healthydev"
