...
const Modal = ({ onClick, onClose, title, Content, hideCloseBtn, btnText }) => {
	return (
		<div>
			<div className="absolute top-0 left-0 right-0 bottom-0 bg-gray-900 opacity-50"></div>
			<div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
				<div className="relative h-[40vh] w-[30vw] bg-white !opacity-100 rounded-lg z-10 p-10 dark:bg-[#111]">
					{
						!hideCloseBtn && (
							<GrClose
								onClick={onClose}
					...
					<h2 className="text-gray-800 dark:text-gray-300 font-semibold text-2xl mb-4">{title}</h2>
